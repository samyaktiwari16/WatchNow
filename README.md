<img width="1899" height="856" alt="Screenshot 2026-02-04 224718" src="https://github.com/user-attachments/assets/6a32a4dd-f000-49a8-be0a-bb6ba7eb906f" />

# 🫣 WatchNow
<p> WatchNow is full stack movie web application which allow users to explore movies and provide various functionalities.</p>
...
## 🚀 Features 
<p>1. User authentication(Login/Signup).</p>
<p>2. User can add movies and remove from watchlist.</p>
<p>3. User can add movies and remove from favourite.</p>
<p>4. Movies are filter on the basis of genre only at home page.</p>
<p>5. Search Functionalities are available </p>

## ⚙️ Installation
<p> git clone https://github.com/samyaktiwari16/WatchNow.git</p>

### Install Requriments
<p> cd WatchNow_Backend/Backend</p>
